...
# trades = Trades([Trade(my_offer=Offer(Credits(quantity=CreditsQuantity(trade["LocalCurrencyAmount"])),
#                                       TradeInventory([Item(name=Name(e)) for e in trade["LocalProducts"]])),
#                        him_offer=Offer(Credits(quantity=CreditsQuantity(trade["RemoteCurrencyAmount"])),
#                                        TradeInventory([Item(name=Name(e)) for e in trade["RemoteProducts"]])))
#                  for trade in content_file])
#
#
# def test_filter_sales():
#     sales = trades.filter_by_trade(lambda trade: trade.is_sell())
#     print(sales)
#
#
...
#     item_by_item = trades.filter_by_trade(lambda trade: trade.is_item_for_item())
#     print(item_by_item)
#
#
