...
from rl_data_utils.item import Platforms, Platform, Color
...
gameflip_data = Items([DataItem(platform=Platforms(PLATFORMS) if data['platform'] == 'all' else Platform(data['platform']),
