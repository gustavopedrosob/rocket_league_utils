...
from rl_data_utils.item.attribute.preset import AVIATOR, ACROBAT, VICTOR, PLAYMAKER, PARAGON, GUARDIAN, SWEEPER,\
    TURTLE, TACTICIAN, SHOW_OFF, JUGGLER, GOALKEEPER, NONE, STRIKER, SNIPER, SCORER
